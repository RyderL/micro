...
public class RibbonConfiguration {
     ...
     */
    @RibbonClient(name = "pay", configuration = RibbonConfiguration.RibbonConfigPay.class)
    static class RibbonConfigPay {
        @Bean
        public IRule rule() {
    ...
    @RibbonClient(name = "order", configuration = RibbonConfiguration.RibbonConfigOrder.class)
    static class RibbonConfigOrder {
        @Bean
        public IRule rule() {
            return new RandomRule();
        }
